...
export const SDKAPPID = 1400784559;
 ...
 */
export const SECRETKEY = 'e7337ddbd4f6cee5f677cff66794b4911859f740eed5df5f7e276b1e0273e708';
...
//   }
//   const generator = new LibGenerateTestUserSig(SDKAPPID, SECRETKEY, EXPIRETIME);
//   const userSig = generator.genTestUserSig(data.userId);
...
export function getBasicIndfoByServer(data){
  if (SDKAPPID === Number(0) || SECRETKEY === String('')) {
    alert('Please configure your SDKAPPID in config/basic-info-config.js');
    return;
  }
